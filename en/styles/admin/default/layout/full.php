...
<html lang="en">
    <head>
        ...
        <meta name="author" content="marriam <marriam@elmanawy.info>" />
            ...
            <div class="sidebar-menu toggle-others fixed">
                <div class="sidebar-menu-inner">
                    ...
                    <ul id="main-menu" class="main-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('admin/pricing_plans') ?>">
                                <i class="fa fa-dollar"></i>
                                <span class="title"> <?php echo lang('global_pricing_plans') ?></span>
                            </a>	
                        </li>
                        <li>
                ...
                <footer class="main-footer sticky footer-type-1">
                    <div class="footer-inner">
                        <div class="footer-text">
                            <strong><a href="https://elmanawy.info/"><?php echo '© marriam amsi ' . date("Y") ?></a></strong>.
                        </div>
                        <div class="go-up">
                            <a href="#" rel="go-top">
