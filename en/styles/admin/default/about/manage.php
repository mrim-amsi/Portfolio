            ...
            <div class="tabs-vertical-env">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="v-statics">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-1"> <?php echo lang('global_Awards_Won') ?></label>
                            <div class="col-sm-10">
                                <?php echo form_input('about[num_awards]', set_value('about[num_awards]', $item->num_awards), 'class="bg-focus form-control"') ?>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
