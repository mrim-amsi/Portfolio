<div class="page-title">
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <strong> <?php echo lang('global_users') ?></strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"> <?php echo lang('global_users') ?></h3>
        <div class="panel-options">
            <a href="<?php echo site_url('admin/users/manage'); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
    <div class="panel-body">
       <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                <thead>
                    <tr>
                        <th><?php echo lang('global_username') ?></th>
                ...
                <tbody class="middle-align">
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->user_id; ?>">
                            <td><img src="<?php echo base_url() ?>cdn/users/<?php echo $item->image ?>" class="img-inline userpic-32" width="28" /> <?php echo $item->username ?></td>
