...
<div class="content-pages">
    ...
    <div class="sub-home-pages">
        <!-- Start Page home -->
        <section id="home" class="sub-page start-page" style="display: table!important;">
        ...
        <!-- About Me Subpage -->
        <section id="about-me" class="sub-page" style="display: block!important;">
        ...
        <?php if (config('display_resume') == '1'): ?>
            <section id="resume" class="sub-page"  style="display: block;">
                <div class="sub-page-inner">
                    <div class="section-title">
                        <div class="main-title">
                            <div class="title-main-page">
        ...
        <?php if (config('display_portfolio') == '1'): ?>
            <section id="portfolio" class="sub-page " style="display: block !important;">
                <div class="sub-page-inner">
                    <div class="section-title">
                        <div class="main-title">
                            <div class="title-main-page">
        ...
        <!-- Contact Subpage -->
        <section id="contact" class="sub-page" style="display: block!important;">
            <div class="sub-page-inner">
                <div class="section-title">
                    <div class="main-title">
                        <div class="title-main-page">
                    ...
                    <div class="pt-50">
                        <div class="social-media-block">
                            ...
                            <ul class="social-media-links">
                                ...
                                <?php if (config('twitter')): ?><li><a href="<?php echo config('twitter') ?>" target="_blank"><i class="fab fa-github"></i></a></li><?php endif ?>
