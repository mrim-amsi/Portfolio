<div class="page-title">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <strong><?php echo lang('global_services') ?></strong>
            </li>
        </ol>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"> <?php echo lang('global_services') ?></h3>
        <div class="panel-options">
            <a href="<?php echo site_url('admin/services/manage'); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i>  <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
            ...
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                ...
                <tbody class="middle-align">
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->service_id ?>">
                            <td><img src="<?php echo base_url() ?>cdn/services/<?php echo $item->image ?>" class="img-circle img-inline userpic-32" width="28" />  <?php echo $item->title ?></td>
                            <td>
...
<script type="text/javascript">
    $(".remove").click(function(){
        ...
        {
            $.ajax({
               url: '<?php echo site_url() ?>admin/services/delete/'+id,
               type: 'DELETE',
               error: function() {
