<div class="page-title">
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <strong> <?php echo lang('global_experiences') ?> </strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo lang('global_experiences') ?> </h3>
    </div>
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1"><?php echo lang('global_company') ?></label>

                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="<?php echo lang('global_company') ?>" name="company"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="padd-top-7">
                        <?php echo form_checkbox('current', 1, set_value('current', $item->current), "class='current'") ?> <?php echo lang('i_currently_word') ?>
                    </div>
                </div>
            </div>
            <div class="form-group-separator"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="<?php echo site_url('admin/experiences'); ?>" class="btn btn-danger"><?php echo lang('global_cancel') ?></a>
                </div>
            </div>
        </form>
    </div>
