...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/testimonials/manage'); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i>  <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
            ...
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                ...
                <tbody class="middle-align">
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->testimonial_id ?>">
                            <td><img src="<?php echo base_url() ?>cdn/testimonials/<?php echo $item->image ?>" class="img-circle img-inline userpic-32" width="28" />  <?php echo $item->name ?></td>
                            <td>
                                <?php echo $item->position ?>
                            </td>
                            <td>
                                <a href="<?php echo site_url('admin/testimonials/manage/' . $item->testimonial_id); ?>" class="btn btn-orange btn-sm">
...
<script type="text/javascript">
    $(".remove").click(function(){
        ...
        {
            $.ajax({
               url: '<?php echo site_url() ?>admin/testimonials/delete/'+id,
               type: 'DELETE',
               error: function() {
